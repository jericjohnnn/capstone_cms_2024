  ...
  <div class="flex flex-col">
    <div class="mb-6">
      ...
      <div class="bg-white rounded-lg shadow-sm border border-gray-200 overflow-hidden">
        <!-- Header Row -->
        <div class="flex font-semibold text-gray-700 bg-green-50 justify-between py-3 px-4 border-b">
        ...
        <div class="overflow-y-auto max-h-[calc(100vh-16rem)]">
          <div v-for="tutor in filteredTutors"
               :key="tutor.id"
               class="flex items-center text-gray-600 justify-between py-3 px-4 hover:bg-green-50/50 transition-colors border-b last:border-b-0">
