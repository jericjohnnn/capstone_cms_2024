<template>
  <div class="p-4">
    ...
    <div v-if="currentView === 'list'">
      ...
      <!-- Empty State -->
      <div v-else-if="reports.length === 0" class="flex items-center justify-center h-64">
        <div class="text-gray-600">No reports available.</div>
      </div>
          ...
          <div class="flex items-center gap-x-4">
            ...
            <div class="flex items-center gap-x-4">
              <span :class="{
                ...
                'bg-yellow-100 text-yellow-700': report.report_status === 'Pending',
                'bg-green-100 text-green-700': report.report_status === 'Resolved',
                'bg-red-100 text-red-700': report.report_status === 'Rejected'
              }">
